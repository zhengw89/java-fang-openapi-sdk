...
public class SaleVillaUpdateRequest extends BaseUpdateRequest {
	...
	// public String getSnImgStr() {
	// return snImgStr;
	// }
	//
	// public void setSnImgStr(String snImgStr) {
	// this.snImgStr = snImgStr;
	// }
	...
	// public String getXqImgStr() {
	// return xqImgStr;
	// }
	//
	// public void setXqImgStr(String xqImgStr) {
	// this.xqImgStr = xqImgStr;
	// }
	...
	// public String getHxImgStr() {
	// return hxImgStr;
	// }
	//
	// public void setHxImgStr(String hxImgStr) {
	// this.hxImgStr = hxImgStr;
	// }
