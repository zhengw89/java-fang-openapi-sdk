...
public class SaleOfficeInputRequest extends BaseInputRequest {
	...
	protected SaleOfficeInputRequest() {
	...
	// public String getJtImgStr() {
	// return jtImgStr;
	// }
	//
	// public void setJtImgStr(String jtImgStr) {
	// this.jtImgStr = jtImgStr;
	// }
	...
	// public String getPmImgStr() {
	// return pmImgStr;
	// }
	//
	// public void setPmImgStr(String pmImgStr) {
	// this.pmImgStr = pmImgStr;
	// }
	...
	// public String getNjImgStr() {
	// return njImgStr;
	// }
	//
	// public void setNjImgStr(String njImgStr) {
	// this.njImgStr = njImgStr;
	// }
	...
	// public String getWjImgStr() {
	// return wjImgStr;
	// }
	//
	// public void setWjImgStr(String wjImgStr) {
	// this.wjImgStr = wjImgStr;
	// }
